...
def login():
    if request.method == 'POST':
        ...
        con = pymysql.connect(host='localhost', user='root', password='mqc201348', database='roomsystem',
                              charset='utf8')
        cur = con.cursor()
...
def AdminInputClass():
    ...
    if cid == "" or cname == "" or teacher == "" or room == "" \
        ...
        con = pymysql.connect(host='localhost', user='admin', password='mqc201348', database='roomsystem',
                              charset='utf8')
        cur = con.cursor()
